...
When calculating Support, each player compares their Wins to the player with the most Wins.

For example in a three player game, Alice has 4 wins, Bob has 3 wins, and Carmen has 2 wins. Bob will get 30g worth of Support for this game as he has 1 less win than Alice, while Carmen will get 60g worth of Support, as she has 2 less wins than Alice.
...
A unit may Intercept any enemy attempting to Engage as per the usual Interception rules, even if that enemy is not attempting to Engage an ally of the unit.

### Ranged Phase

A unit may target a Melee combat, provided that no allies are Engaged in that Melee. If a Melee is targeted, randomly determine who the exact target of the Ranged Attack is and then resolve the attack as normal.
