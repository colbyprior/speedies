...
After creating the campaign, choosing Neutral Heroes, and creating warbands, it's time to begin the campaign! For any individual player, the general loop of a campaign will be as follows:
...
The Special Scenario may be against a player you played against recently, but will have special rules and more explicit narrative elements involving Neutral Heroes. Special Scenarios will be described in more detail in the next section.
...
First, if there is more than one player in a Faction, a single regular battle is played between all players of the same Faction. The winner of that battle is then chosen as the representative of the Faction in the finale Special Scenario. No Support Points for having fewer wins are given in this battle, so players with more wins will generally have an advantage over those that don't.

For these battles, a standard 'dense city' map should be used and the deployment types should be limited to 'Edge deployment' or 'Corner deployment' (reroll if another deployment type is rolled). In addition, as there is no incentive to voluntarily rout, the third Rout Check onwards that a player makes within this battle will be made with Disadvantage.
...
For the final Special Scenario, the final players face off in a multiple battle. The exact scenario should have been chosen at the start of the campaign. The winner of this Special Scenario is the overall winner of the campaign!

For the final scenario, you have the option of the losers of the previous match controlling some units, such as the Neutral Hero of the player that they lost against. This allows players to stay engaged during the finale, while also speeding the game up.
