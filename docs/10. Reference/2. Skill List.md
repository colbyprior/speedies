...
This unit gains +1 Atk when Engaged with more than one enemy. To gain this benefit, the unit must spread their attacks across at least two enemies.
### Drag You Down
*Melee*

If this unit is Incapacitated in Melee, all enemies Engaged with this unit must make a Mishap Roll immediately after the current attacker finishes resolving their attacks`.
### Dual Wielding Specialist
*Melee*

If this unit is dual wielding Melee weapons, it has Advantage on Injury Checks in Melee. This means that, if this unit hits, roll a second d20 and use that as the Injury value if it is higher than the Melee Check result (before modifiers).
...
This unit can trigger a critical strike on a 18-20.
### Shove
*Melee*
...
Blackpowder weapons used by this unit have Advantage up to their full range while elevated, rather than half range.
### Heavy Gunner
*Ranged*
...
If this unit is using a single one-handed weapon and no Shield, they have Advantage on Melee Checks and Defence Checks in Melee. This can be used by all Magic users.
### Leap
*Agility*
...
This unit's Run speed is +6" rather than the usual +3".
### Thief
*Agility*
...
Once per turn, after an enemy Engages an ally within 5" of this unit, this unit may make a Morale Check. On a success, this unit becomes Engaged with the enemy unit. The enemy still counts as Engaging for the purpose of attack order.
### Defensive Stance
*Defence*
...
This unit will always treat Mishap Rolls as if it rolled a 1.
### Protector
*Defence*
...
This unit cannot be Staggered and is immune to Fear.
### Stout
*Defence*

This unit gains -2 when checking for Injury for attacks made against them (eg. an unmodified roll of 19 would count as a 17, Stunning rather than Incapacitating the unit).
### Taunt
*Defence*
...
If a unit from your warband triggers an Event, you may draw an additional Neutral Hero card and choose which one will be used for the Event.
### Fear
*Morale*
...
When a unit of your warband dies you can keep one piece of equipment from that unit. This skill can be used once per game and cannot be used on Artifacts.
### Iron Will
*Morale*
...
This unit's single target Spells have their range increased by 5".
### War Caster
*Morale*

This unit has Advantage on Morale checks for Ongoing Spells.
