...
Only heroes can equip and use loot and can only have one Consumable and one Rare Oddment, Weapon, or Armour equipped at any one time.
...
| 4   | Poison Vial                 | Use at end of the Upkeep Phase. The Injury Checks of one unit's Melee Attacks are rolled with Advantage for the rest of the scenario.                                                                                                                                                                                                                                                                           |
...
| 5   | Bracers of Archery          | Bows all gain +2 Inj.                                                                                                                                                                                                                     |
...
| 18  | Wand of Polymorph           | Difficulty 15. Ongoing. On a success, the target is turned into a Giant Rat, only retaining its current Wounds.                                                                                                                           |
