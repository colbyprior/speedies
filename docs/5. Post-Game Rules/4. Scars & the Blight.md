...
| d20   | Name            | Result                                                                                                           |
| ----- | --------------- | ---------------------------------------------------------------------------------------------------------------- |
| 1     | Blight          | This unit contracts the Blight or gains 'Deathtouched' if they already have the Blight or are immune to it.      |
...
| 9     | Leg Wound       | This unit gains 'Slow' special rule                                                                              |
| 10    | Major Wound     | Roll again: 1-5 Worsen Defence by 2, 6-10 Worsen Melee by 2, 11-15 Worsen Ranged by 2, 16-20 Worsen Agility by 2 |
| 11    | Light Wound     | Miss the next game                                                                                               |
| 12-14 | Nothing happens | Nothing happens                                                                                                  |
| 15-16 | Pit Fight!      | Pit Fight (see below)                                                                                            |
...
| 20    | Improvement     | This unit immediately draws two Improvement Cards from the deck and chooses one. Resolve that Improvement Card.  |
### Deathtouched
...
If a hero rolls 'Pit Fight!', that hero is forced to take part in a Pit Fight against its will, with freedom on the line. The hero faces off in single combat with the 'Pit Fighter' Neutral Hero. Have another player control the Pit Fighter for the duration of this battle. Both units start 5" away from each other. Roll randomly to see who goes first and then begin the fight. Both units must move toward and Engage each other, if possible, unless they Cast a Spell or make a Ranged Attack that turn. The battle continues until either side is Incapacitated. That unit does not need to make a Scar Roll (although Pit Fights that occur during an active game due to the Pit Fighter Neutral Hero Event do require Scar Rolls for the Incapacitated unit, as normal).

#### Winning and Losing Pit Fights

If the hero wins, it gains an Improvement Attempt and gains 50g for its warband. If the hero loses, that hero becomes the new Pit Fighter. The new Pit Fighter still takes up a slot on its warband sheet and immediately gains the 'Pit Fighter' skill, but misses all future games the warband takes part in, until the Pit Fighter is released. For every game it misses, it still gains an Improvement Attempt similar to other heroes. The Pit Fighter Event and Scar Roll result now uses the stats of the new Pit Fighter.
...
If a player's unit is ever in the Pits, they may fund a Pit Fight to get them released earlier (and potentially make some profit in the process). The cost to do so, depends on how many games the unit has missed since it became the Pit Fighter. After a game, they simply pay the cost and the Pit Fight will occur against the Neutral Pit Fighter.
...
| d20  | Result                                                                                     |
| ---- | ------------------------------------------------------------------------------------------ |
| 1    | This unit contracts the Blight or dies if they already have the Blight or are immune to it |
| 2-4  | Death                                                                                      |
