...
Sometimes warbands end up with spare equipment, which they expect to become useful later, usually when they hire more units. At any point after rolling for Scars & Blight and before the next game, players may move equipment between units, from a unit to Stored Equipment or from Stored Equipment to a unit. As usual, units must be able to use such equipment.
...
| 5th       | 100g |
| 6th       | 140g |
For every game played, the cost of each hero slot is reduced by 5g. For example, if a player has played 3 games, the cost for the 5th slot would now be 85g.
