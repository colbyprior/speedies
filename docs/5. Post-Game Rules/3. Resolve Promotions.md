...
3. Increase the warband's hero slots by one (even if there was an empty one before the Promotion) up to a maximum of 6 slots
4. Add the newly Promoted hero to that slot, retaining their existing unit type. If they had the Blight before, they still have it, so mark that checkbox.
