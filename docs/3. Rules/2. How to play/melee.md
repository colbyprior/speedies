...
3. Each unit’s attacks are fully resolved in order of attacking. They are resolved as follows:
  ...
  :::
  :::tip[Wounds]
  If the target fails, their Wounds are reduced by 1. If this lowers their Wounds to 0, the attacker [injures](docs/3.%20Rules/3.%20Injury%20&%20Death/injury.md) them based on what was rolled in the attack. (see the Injuries section for how this is handled)
  :::
