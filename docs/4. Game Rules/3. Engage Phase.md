...
5. If the distance determined in Step 3 means the unit can reach the target via the path, the other player can now decide if they want to Intercept the Engage with one of their units
