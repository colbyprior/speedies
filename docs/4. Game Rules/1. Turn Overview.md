...
After the pre-game deployment and other steps have been completed, the game can begin in proper. Both players alternate taking their turns one at a time. This generally continues until one player has routed, at which point the other player is the winner. When a player routs, their turns are skipped for the remainder of the game.
## Turn Phases
