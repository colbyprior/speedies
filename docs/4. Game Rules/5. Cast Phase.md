...
A Cast Attack has a Cast Difficulty as normal. Should a Caster pass the Cast Check for this spell, the roll of the Cast Check is also used as the result for the Injury Check, similarly to Melee or Ranged Attacks. Also similarly, the opponent makes a Defence Check. Cast Attacks can Crit, in which case the Cast Attack can immediately be Cast again at the same target. Casters cannot Cast Attack into Melee Combats, except those they are Engaged in themselves.
