...
<!--
JP 13-03-25: I have renamed Knocked Down to [Dazed](/Intro/Speedheim%20Terminology#dazed) and Out of Action to Incapacitated. Can chat on if we are happy with these names.
...
JP 23-03-25: Keep [Stunned](/Intro/Speedheim%20Terminology#stunned), [Dazed](/Intro/Speedheim%20Terminology#dazed), Staggered, and Incapaciated. In Melee, can now disengage if there is another ally who is not [Dazed](/Intro/Speedheim%20Terminology#dazed) or [Stunned](/Intro/Speedheim%20Terminology#stunned). To do so, you need to pass an Agi check. You make this Check instead of attacking and sacrifice your attack even if you fail.

CP 07-03-35: This is a rough read without these statuses being hyperlinked. I think we could also create subheadings for [Stunned](/Intro/Speedheim%20Terminology#stunned), [Dazed](/Intro/Speedheim%20Terminology#dazed) and staggered

JP 13-04-25: Add in explicit statements about [Dazed](/Intro/Speedheim%20Terminology#dazed) cannot do jump, climb etc.
-->
...
Table to be added. Will usually be based on the Faction Agents selected, plus some basic Random Happenings too? eg. contracting the Blight. Maybe, if Faction Agents are dead (or have joined a warband), then someone contracts the Blight? Can have a chat on this.
-->
