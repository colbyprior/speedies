...
Table to be added. Will usually be based on the Faction Heroes selected, plus some basic Random Happenings too? eg. contracting the Blight. Maybe, if Faction Heroes are dead (or have joined a warband), then someone contracts the Blight? Can have a chat on this.
-->
