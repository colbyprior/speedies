...
The cap of 2 Skills does not include any Skills or Special Rules that the hero starts with.
...
* Promote a non-Animal, non-Large Henchman if the Incapacitated unit is a Leader! (4 cards)
* Promote a non-Animal, non-Large Henchman if the Incapacitated unit is a Hero! (3 cards)
* Promote! (1 card)
