...
All units have base Stat Caps as per the table below and cannot improve past it under any circumstances. Should a hero need to make a check to Improve a stat that is already at the Stat Cap, draw another card from the Improvement Deck instead.
