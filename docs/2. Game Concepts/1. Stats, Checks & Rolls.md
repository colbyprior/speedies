...
| Ranged  | Rng          | How well a unit can attack from ranged.                                                                                    |
...
One of the common Rolls are 'Injury Rolls', as opposed to 'Injury Checks'. 'Injury Checks' are based on the Melee or Ranged Check performed as part of a Melee or Ranged Attack, whereas Injury Rolls are a straight d20 roll, modifiers are applied a table is consulted for the result. The section on 
Injury will go into more detail in how these work, specifically.
