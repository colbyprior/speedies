...
If this unit is using a one-handed weapon and no Shield, they have Advantage on Melee Checks and Defence Checks in Melee.
### Leap
*Agility*
...
Enemies don't get to automatically attack first in Melee on the turn they Engage. Instead, this unit makes an Agility Check. If it succeeds, it instead attacks first.
### Drag You Down
*Defence*
