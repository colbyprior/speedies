...
After everyone has created their warband, the group can create each Faction for the campaign. This involves collaboratively deciding on who will be part of which Faction and who the Faction Agents of each Faction will be. This will largely dictate the flavour of the campaign and the neutral units players will meet throughout it. Faction creation is explained in more detail in a future section.

## Special Scenario Selection

Finally, the group needs to collaboratively select the Special Scenarios for the campaign. The selection is based on the number of players and the exact makeup of the Factions. This will help give the campaign a more narrative structure, with different warbands trying to accomplish different things throughout the campaign. How to do this is also described in a future section.