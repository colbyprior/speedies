...
| d20   | Deployments                                                                                                        |
| ----- | ------------------------------------------------------------------------------------------------------------------ |
| 1-6   | Team A along one edge, Team B along opposite edge                                                                  |
| 7-12  | Team A in one corner, Team B in opposite corner                                                                    |
| 13-16 | Half of Team A in one corner, other half in opposite corner. Team B is split in half across two remaining corners. |
| 17-18 | Team A in centre, Team B along all edges (whoever rolls to deploy first is Team A)                                 |
| 19-20 | Four equal lengths (1,2,3,4) (see below). Team A deploys anywhere in 1 and 3 and Team B anywhere in 2 and 4.       |

```
Strip Deployment Example:
|------------|
|      1     |
|------------|
|      2     |
